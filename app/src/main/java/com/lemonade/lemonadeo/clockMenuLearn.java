...
public class clockMenuLearn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        analog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(clockMenuLearn.this, ClockLearning.class);
        ...
        digital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(clockMenuLearn.this, Digital.class);
                startActivity(intent);
            }
        });
