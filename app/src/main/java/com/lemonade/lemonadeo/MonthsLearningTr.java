...
public class MonthsLearningTr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playJan = MediaPlayer.create(this, R.raw.ocak);
        playFeb = MediaPlayer.create(this, R.raw.subat);
        playMarch = MediaPlayer.create(this, R.raw.mart);
        playApril= MediaPlayer.create(this, R.raw.nisan);
        playMay = MediaPlayer.create(this, R.raw.mayis);
        playJune = MediaPlayer.create(this, R.raw.haziran);
        playJuly = MediaPlayer.create(this, R.raw.temmuz);
        playAug = MediaPlayer.create(this, R.raw.agustos);
        playSep= MediaPlayer.create(this, R.raw.eylul);
        playOct = MediaPlayer.create(this, R.raw.ekim);
        playNov = MediaPlayer.create(this, R.raw.kasim);
        playDec = MediaPlayer.create(this, R.raw.aralik);
